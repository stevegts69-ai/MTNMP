...
export type TooltipDataAttrs = (value: ContributionChartValue) => Partial<RectProps> | Partial<RectProps>;
declare class ContributionGraph extends AbstractChart<ContributionGraphProps, ContributionGraphState> {
    constructor(props: ContributionGraphProps);
    componentDidUpdate(prevProps: ContributionGraphProps): void;
    ...
    getTooltipDataAttrsForValue(value: ContributionChartValue): Partial<RectProps>;
